...
public class VentanaAgregarCancelacionPasaje extends JFrame{
	...
	private static VentanaAgregarCancelacionPasaje INSTANCE;
	private JLabel lblArs;
	private JTextField textARS;
	private JLabel lblVencimiento;
	private JTextField vencimiento;

	public static VentanaAgregarCancelacionPasaje getInstance(){
		if(INSTANCE == null)
			return new VentanaAgregarCancelacionPasaje();
		else
			return INSTANCE;
	}
	
	public VentanaAgregarCancelacionPasaje() {
