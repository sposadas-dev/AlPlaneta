...
public class VentanaEliminarPais extends JFrame {

	private JPanel contentPane;
	private JTextField txtNombreProvincia;
	private JButton btnEditar;
	private static VentanaEliminarPais INSTANCE;

	public void setTxtNombreProvincia(JTextField txtNombreProvincia) {
		this.txtNombreProvincia = txtNombreProvincia;
	}

	public static VentanaEliminarPais getInstance(){
		if(INSTANCE == null)
			return new VentanaEliminarPais();
		else
			return INSTANCE;
	}
	
	public VentanaEliminarPais() {
