...
public class VentanaEditarViaje extends JFrame {

	private JPanel contentPane;

	private JButton btnEditarViaje;
	private static VentanaEditarViaje INSTANCE;
	...
	public static VentanaEditarViaje getInstance(){
		if(INSTANCE == null)
			return new VentanaEditarViaje();
		else
			return INSTANCE;
	}
	
	private VentanaEditarViaje() {
		...
		JLabel lblAgregarReserva = new JLabel("Editar viaje");
		...
		btnEditarViaje = new JButton("Editar Viaje");
		btnEditarViaje.setEnabled(true);
		btnEditarViaje.setBounds(345, 307, 173, 37); 	
	...
	public void setBtnCrearViaje(JButton btnCrearViaje) {
		this.btnEditarViaje = btnCrearViaje;
	}
	...
	public JTextField getTextFechaDestino() {
		return textFechaDestino;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaEditarViaje frame = new VentanaEditarViaje();
