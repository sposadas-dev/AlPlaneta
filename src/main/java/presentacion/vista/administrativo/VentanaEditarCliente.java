...
public class VentanaEditarCliente extends JFrame {
	...
	private static VentanaEditarCliente ventanaEditarCliente;

	public static VentanaEditarCliente getInstance() {
		if (ventanaEditarCliente == null) {
			ventanaEditarCliente = new VentanaEditarCliente();
			return ventanaEditarCliente;
		} else {
			return ventanaEditarCliente;
		}
	}
	...
	public VentanaEditarCliente() {
			...
			btnEditar.setBounds(150, 399, 131, 42);
