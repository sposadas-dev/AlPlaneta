...
public class VentanaTablaViajesPromocion extends JFrame {

	private static VentanaTablaViajesPromocion INSTANCE;
	...
	public static VentanaTablaViajesPromocion getInstance(){
		if(INSTANCE == null)
			INSTANCE =  new VentanaTablaViajesPromocion();
		return INSTANCE;
	}
	
	private VentanaTablaViajesPromocion() {
